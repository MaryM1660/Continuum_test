# Apple HIG Typography Specifications - Полные данные
...
## Таблица 1: Platform Default and Minimum Sizes
...
## Таблица 2: macOS Dynamic Font Variants
...
### Таблицы 17-25: watchOS (xSmall, Small, Large, xLarge, xxLarge, xxxLarge, AX1, AX2, AX3)

**Примечание:** Полные данные извлечены из браузера. См. детали в структурированном формате ниже.

---

## Tracking Values (Letter Spacing)

### Таблицы 26-32: Tracking для разных шрифтов

**Примечание:** Полные таблицы содержат значения для размеров от 6pt до 96pt+ с точными значениями tracking в 1/1000 em и points.

**Шрифты:**
- SF Pro (iOS/iPadOS/visionOS)
...
1. Извлечь полные таблицы watchOS Dynamic Type sizes
